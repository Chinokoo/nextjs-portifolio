      ...
      <div className="grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] items-center">
        <div>
          ...
          <h2 className="text-[25px] md:text-[35px] lg:text-[45px] md:leading-[3rem] capitalize mb-[3rem] font-bold text-white ">
            Transforming <span className="text-yellow-400">Ideas</span>
          </h2>
        ...
        >
          ...
          />
          <div className="absolute w-[100%] h-[100%] z-[10] bg-[#55e6a5] bottom-[2rem] left-[1rem] "></div>
        </div>
      </div>
    </div>
  );
